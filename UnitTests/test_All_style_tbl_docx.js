...
describe('style in table', function () {
    it('all style in table', function (done) {
        try {
            var data = [
            ...
            *****/
            var style = [
                { x: 1, y: 0 },
                { x: 1, y: 1, fontFamily: 'B Nazanin', fontSize: 18, fontColor: 'white', align: 'center', background: 'black', borderSize: 30 },
                { x: 1, y: 2 },
                { x: 2, y: 0 },
            ...
            var docx = new Docx_1.Docx('test_All_style_tbl.docx', 'outputUnitTest/');
...
//# sourceMappingURL=test_All_style_tbl_docx.js.map