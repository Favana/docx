...
describe('docx', function(){
    it('MergeRow_Tbl_docx',  function(done){
        try{
            let data = [
                {x: 1, y: 0, value: '',mergeRow:'3', mergeCol:''},       //mergeRow:(x) ,,,, mergeCol:(y)
            ...
            let docx = new Docx('test_MergeRow_Tbl.docx', 'outputUnitTest/');
