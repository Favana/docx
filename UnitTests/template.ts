...
describe('default Template', function(){
    ...
    it('template Three',  function(done){ //    فایل مربوط به تفکیک جمعیت شهرستان   ///
        ...
        let data = [
            {x: 1, y: 0, value: '',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},   //mergeRow:(x) ,,,, mergeCol:(y)
            {x: 1, y: 1, value: 'سال 1390', mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},
            {x: 1, y: 2, value: 'سال 1391',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},
            {x: 1, y: 3, value: 'سال 1392',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},
            {x: 1, y: 4, value: 'سال 1393',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},
            {x: 1, y: 5, value: 'سال 1394',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},
            {x: 1, y: 6, value: 'سال1395',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},


            {x: 2, y: 0, value: 'کل',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},   //mergeRow:(x) ,,,, mergeCol:(y)
            ...
            {x: 3, y: 0, value: 'البرز',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},   //mergeRow:(x) ,,,, mergeCol:(y)
            ...
            {x: 4, y: 0, value: 'بندرعباس',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},   //mergeRow:(x) ,,,, mergeCol:(y)
            ...
            {x: 5, y: 0, value: 'گیلان',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},   //mergeRow:(x) ,,,, mergeCol:(y)
            ...
            {x: 6, y: 0, value: 'گلستان',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},   //mergeRow:(x) ,,,, mergeCol:(y)
            ...
            {x: 7, y: 0, value: 'یزد',mergeRow:'', mergeCol:'',style:{background:'#f7f7f7',align:'center',fontFamily:'B Nazanin', border:{top:'17', bottom:'17',left:'17',right:'17'}}},   //mergeRow:(x) ,,,, mergeCol:(y)
   ...
   it('Template Five',  function(done){  /// كاركنان شاغل در دانشگاههاي علوم پزشكي بر حسب گروه شغلي
        ...
        ****/
        ...
        let docx = new Docx('temp5.docx', 'outputUnitTestTmp/');
        docx.createP();
        docx.addContentP('١-١7- كاركنان شاغل در دانشگاههاي علوم پزشكي بر حسب گروه شغلي' ,{fontSize:11, bold:"true"})
        docx.createTable(data);
        docx.createP();
        docx.createP();
        ...
        docx.createP();
        docx.addContentP('٤)شامل آمار دانشگاه هاي علوم پزشکي اهواز و بهبهان نمي باشد. ', {fontSize:"10"});
        docx.createP();
        docx.addContentP('٥)شامل آمار دانشگاه هاي علوم پزشکي ياسوج نمي باشد. ', {fontSize:'10'});
        docx.createP();
        docx.addContentP('مأخذ - وزارت بهداشت، درمان و آموزش پزشكي. (ر. پ). ', {fontSize:'10'});
        docx.createP();
        docx.addContentP('       - وزارت بهداشت، درمان و آموزش پزشكي. دفتر مديريت آمار و فناوري اطلاعات . ',{fontSize:'10'})
        let out = docx.generate();
        if(out == false){
            fail("Don't create File of docx");
        }else{
