...
describe('style in table', function () {
    it('test_bold_text_style', function (done) {
        try {
            var data = [
            ...
            var docx = new Docx_1.Docx('test_bold_text_style_tbl.docx', 'outputUnitTest/');
    ...
    }); //  it for test_bold_text_style
}); //  describe
//# sourceMappingURL=test_bold_text_style_tbl_docx.js.map