...
describe('style in table with new data', function () {
    it('style Without merge', function (done) {
        var data = [
            { x: 1, y: 0, value: '', mergeRow: '2', mergeCol: '', style: { borderSize: 30 } },
        ...
        var docx = new Docx_1.Docx('test_newData_with_merge_style_tbl.docx', 'outputUnitTest/');
...
//# sourceMappingURL=test_newData_with_merge_style_tbl.docx.js.map