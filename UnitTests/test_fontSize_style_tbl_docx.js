...
describe('style in table', function () {
    it('test_fontSize_style_tbl_docx', function (done) {
        try {
            var data = [
            ...
            var docx = new Docx_1.Docx('test_fontSize_style_tbl.docx', 'outputUnitTest/');
    ...
    }); // it test_fontSize_style_tbl_docx
}); // describe
//# sourceMappingURL=test_fontSize_style_tbl_docx.js.map