...
describe('style table', function () {
    it('test_fontColor_style_tbl_docx', function (done) {
        try {
            var data = [
            ...
            var docx = new Docx_1.Docx('test_fontColor_style_tbl.docx', 'outputUnitTest/');
...
//# sourceMappingURL=test_fontColor_style_tbl_docx.js.map